...
/**
 * WASDQZ component to control entities using WASDQZ keys.
 */
AFRAME.registerComponent('wasdqz-controls', {
  ...
  updateVelocity: function (delta) {
    ...
    if (data.qzEnabled) {
      ...
      if (keys.KeyZ) { velocity[qzAxis] -= qzSign * acceleration * delta; }
      if (keys.KeyQ) { velocity[qzAxis] += qzSign * acceleration * delta; }
    }    
  },
